...
from pytia_bounding_box.const import APP_NAME, APP_VERSION
from pytia_bounding_box.resources.utils import expand_env_vars

console = Console()
settings_path = Path("./pytia_bounding_box/resources/settings.json").resolve()
